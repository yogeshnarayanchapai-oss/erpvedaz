...
export default function AdminUnifiedDashboard() {
  ...
  // Redirect ADMIN and MANAGER to Sales Dashboard - Only OWNER accesses Unified Dashboard
  useEffect(() => {
...
const hrmMetrics = useMemo(() => {
  ...
  return (
    <div className="min-h-full flex flex-col animate-fade-in px-1 md:px-0">
      ...
      {/* Quick Summary Stats Bar - Responsive grid with 6 items */}
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1 md:gap-1.5 mb-1.5 md:mb-2">
        ...
        {/* Pending Tasks - Store-wise count */}
        <Card className="bg-gradient-to-br from-amber-500/10 to-amber-600/5 border-amber-200/50 dark:border-amber-800/50 cursor-pointer hover:shadow-md transition-shadow" onClick={() => navigate('/hrm/tasks')}>
          <CardContent className="p-2 md:p-3">
            <div className="flex items-center gap-2">
