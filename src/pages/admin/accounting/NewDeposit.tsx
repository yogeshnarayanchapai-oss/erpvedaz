...
export default function NewDeposit() {
  ...
  const { data: categories = [] } = useTransactionCategories('income');
        ...
        <Card className="max-w-md">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              You don't have permission to create deposits. Only OWNER and ACCOUNTANT roles can create transactions.
            </p>
  ...
  return (
    <div className="p-6 space-y-6 animate-fade-in">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">New Deposit (Income)</h1>
          <p className="text-muted-foreground">Record money received</p>
        </div>
      </div>
