    ...
    <>
      <div className="overflow-x-auto">
        <Table className="text-sm">
          <TableHeader>
            <TableRow>
              <TableHead className="whitespace-nowrap"><HeaderWithHelp label="Date" helpKey="date" /></TableHead>
              <TableHead className="text-right"><HeaderWithHelp label="Sells" helpKey="sell" /></TableHead>
              <TableHead className="text-right"><HeaderWithHelp label="Ads" helpKey="ads_spent_npr" /></TableHead>
              <TableHead className="text-right"><HeaderWithHelp label="Act.P.V" helpKey="actual_product_value" /></TableHead>
              <TableHead className="text-right"><HeaderWithHelp label="Act.P.C" helpKey="actual_product_cost" /></TableHead>
