...
export function NewPaymentInDialog({ open, onOpenChange, onChangeType }: Props) {
      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center justify-between">
            ...
            <TransactionTypeBadge type="PAYMENT_IN" onChangeType={onChangeType ? () => { onOpenChange(false); onChangeType(); } : undefined} />
          </div>
        </DialogHeader>
