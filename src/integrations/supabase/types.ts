  ...
  public: {
    Tables: {
      ...
      ad_spend_reference: {
        ...
        Relationships: [
          {
            foreignKeyName: "ad_spend_reference_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "ad_spend_reference_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
      ...
      consignment_setting_options: {
        ...
        Relationships: [
          {
            foreignKeyName: "consignment_setting_options_store_id_fkey"
            columns: ["store_id"]
            isOneToOne: false
            referencedRelation: "stores"
            referencedColumns: ["id"]
