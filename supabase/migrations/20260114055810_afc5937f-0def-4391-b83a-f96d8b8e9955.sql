-- Fix RLS policy for LEADS role to include assigned leads
...
FOR SELECT USING (
  ...
  OR (
    ...
    AND (
      ...
      -- LEADS can see: leads in LEADS team, pool leads, OR leads assigned to them
      -- REMOVED: created_by_user_id visibility (creators should NOT see after transfer)
