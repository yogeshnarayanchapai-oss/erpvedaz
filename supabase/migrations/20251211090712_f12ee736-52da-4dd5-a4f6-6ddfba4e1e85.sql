-- Fix the get_customer_insight function - use correct column name for products
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    'store_id', c.store_id,
    'store_name', s.name,
    'handled_by_name', p.name,
    'last_product_name', pr.name,
    'last_product_price', COALESCE(lo.total_amount, pr.sell_price),
